...
const NoticePage = () => {
  const downloadUrl1 = `${process.env.PUBLIC_URL}/application/2023년_ODBY_예술_X_기술_R&D_과정모집.docx`;
  const downloadUrl2 = `${process.env.PUBLIC_URL}/application/2023년_ODBY_예술_X_기술_R&D_과정모집.hwp`;
          ...
          <Stack
            ...
            <Stack sx={{ paddingX: isMobile ? 2 : 20 }}>
              ...
              <ul>
                ...
                <li>기술 PD 컨설턴트 진행</li>
                <li>R&amp;D 마지막 과정 중간평가를 통해 선정된 프로젝트는 이후 본 프로젝트의 구체화 과정에 대한 예산을 지원받을 수 있습니다.(중간평가 선정 예산안 1천만 원)</li>
              </ul>
              ...
              <p>지원신청서 제목: 2023_ODBY_R&amp;D_과정지원신청서_(개인/단체명)</p>
